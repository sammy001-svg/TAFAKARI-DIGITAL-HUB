              ...
              {CAROUSEL_SLIDES.map((_, i) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-500 ${
                    i === slide ? "w-8 bg-emerald-400" : "w-2 bg-white/30 hover:bg-white/50"
                  }`}
                />
              ))}
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                required
                className="w-full bg-slate-900 border border-white/10 rounded-xl px-4 py-3.5 text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all"
