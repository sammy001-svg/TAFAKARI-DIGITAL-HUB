        ...
        {episodes.map((ep) => (
          <div key={ep.id} className="glass p-8 rounded-[2rem] border-secondary/20 flex flex-col md:flex-row items-center gap-8 transition-all hover:border-white/40 hover:shadow-2xl text-white">
            ...
            <div className="flex gap-4">
               ...
               <button className="px-4 py-2 bg-white text-primary rounded-full text-xs font-semibold hover:bg-slate-100 transition-colors">Download</button>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="mt-20 p-12 bg-[#3B0708] rounded-[3rem] text-white relative overflow-hidden border border-secondary/20">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="space-y-4">
            ...
            <p className="text-slate-300 max-w-md">Never miss an episode. Get our latest field discussions delivered directly to your device.</p>
          </div>
